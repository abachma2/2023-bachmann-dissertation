...
\begin{frame}
    ...
    \begin{columns}
        ...
        \begin{figure}
            \centering 
            \includegraphics[scale=0.45, trim=0 30 0 30,clip]{comparison_pu_cumulative.pdf}
...
\begin{frame}
    ...
    \begin{columns}
        ...
        \begin{figure}
            \centering 
            \includegraphics[scale=0.45, trim=0 30 0 30,clip]{comparison_pu_cumulative_discharge.pdf}
            \caption{Comparison of cumulative separated plutonium in benchmark between 
            OpenMCyclus and \Cycamore \texttt{Reactor}.}
        \end{figure}
    \end{columns}
