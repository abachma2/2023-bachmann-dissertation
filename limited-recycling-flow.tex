\begin{figure}
    ...
    \begin{tikzpicture}[node distance=1.5cm]
        ...
        \draw [arrow] (wetstorage) -- node[sloped, anchor=south, text width=2cm]{Cool Spent UOX}(separation);
        \draw [arrow] (cooling) -| node[pos=0.8, anchor=east, text width=1cm]{Spent Recycled Fuel}(sinkhlw);
        \end{tikzpicture}
