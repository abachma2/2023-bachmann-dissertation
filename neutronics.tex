...
weight fraction. Table \ref{tab:u_comps} defines the uranium isotopics used 
in each reactor type for each of the \gls{HALEU} compositions.
...
are compared at \gls{BOL}, \gls{MOL}, and \gls{EOL}. Each metric provides a 
