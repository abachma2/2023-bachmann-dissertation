\begin{figure}
    ...
    \begin{tikzpicture}[node distance=1.5cm]
        ...
        \draw [arrow] (wetstorage) -- node[sloped, anchor=north, text width=2cm]{Cool Spent UOX}(separation);
        \draw [arrow] (cooling) -| node[pos=0.4, anchor=west, text width=1cm]{Spent Recycled Fuel}(sinkhlw);
        \draw [arrow] (drystorage) -- (separation);
        \draw [arrow] (mine) -| node[anchor=south]{Natural uranium} (fuelfab);
        \end{tikzpicture}
