\begin{frame}
    ...
    \begin{itemize}
        ...
        \item<2-> Quantify material requirements for different fuel cycles
    \end{itemize}
    ...
    \input{once-through-flow}
        ...
        \begin{itemize}
            ...
            \item<3-> Assume natural uranium is enriched to produce all 
                  fuel
            \item<3-> Materials quantified include uranium mass, \gls{SWU} 
                 capacity, feed uranium, and used nuclear fuel (UNF)
        \end{itemize}
...
\begin{frame}
    ...
    \begingroup
        ...
        \begin{table}
            ...
            \vspace{-0.15cm}
            \begin{tabular}{ l p{1.5cm} p{1.6cm} p{2cm} }
                \hline
                ...
                Fuel form & UO$_2$ FCM & UCO TRISO & UO$_2$ pellets \\
                Power (MWe) & 5 & 80 & 77\\
    ...
    \frametitle{Once-through scenario definitions}
        \begin{table}[ht]
            ...
            \begin{tabular}{c l l}
                    ...
                    \rowcolor{lightgray}2 & \glspl{LWR} and MMR & No growth \\
                    \rowcolor{lightgray}3 & \glspl{LWR} and Xe-100 & No growth \\
                    \rowcolor{lightgray}4 & \glspl{LWR}, Xe-100, and MMR& No growth\\
                    \rowcolor{lightgray}5 & \glspl{LWR}, MMR, and VOYGR & No growth\\
                    \rowcolor{lightgray}6 & \glspl{LWR}, Xe-100, and VOYGR & No growth\\
                    \rowcolor{lightgray}7 & \glspl{LWR}, Xe-100, MMR, and VOYGR & No growth\\
...
\begin{frame}
    \frametitle{Once-through scenario definitions}
        \begin{table}[ht]
            ...
            \caption{Summary of the once-through fuel cycle transition scenarios.
            Energy growth is relative to energy from \glspl{LWR} in 2025.}
            \label{tab:scenarios_once-through_box}
            \begin{tabular}{c l l}
                \hline
                Scenario number & Reactors present & Energy demand\\\hline
                \rowcolor{lightblue} 1 & \glspl{LWR} & N/A \\
                \rowcolor{lightgray}\marktopleft{a3}2 & \glspl{LWR} and MMR & No growth \\
                \rowcolor{lightgray}3 & \glspl{LWR} and Xe-100 & No growth \\
                \rowcolor{lightgray}4 & \glspl{LWR}, Xe-100, and MMR& No growth\\
                \rowcolor{lightgray}5 & \glspl{LWR}, MMR, and VOYGR & No growth\\
                \rowcolor{lightgray}6 & \glspl{LWR}, Xe-100, and VOYGR & No growth\\
...
\begin{frame}
    ...
    \begin{columns}
        \column[t]{5cm}
            Calculate the deployment scheme for advanced reactors outside \Cyclus
            \begin{itemize}
                \item Apply a modified greedy algorithm 
