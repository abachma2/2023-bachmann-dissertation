...
of 217 points, shown in Figure \ref{fig:once-through_pareto}. The points 
on this figure identify different values of each objective that are equally 
optimized; in order to improve one objective the other objective becomes w
...
burnup becomes irrelevant if none of the reactors are deployed in the
transition.
