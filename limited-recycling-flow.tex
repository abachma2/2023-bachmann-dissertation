\begin{figure}
    ...
    \begin{tikzpicture}[node distance=1.5cm]
        ...
        \draw [arrow] (wetstorage) -- node[anchor=west]{Cool Spent UOX} (separation);
        \end{tikzpicture}
    ...
    in 2025. In all limited recycling scenarios the spent UOX from the VOYGRs is sent to the 
    Separations facility. In Scenarios 14 and 17 the spent UOX fuel from the Xe-100 and 
    MMR are also sent to the Separations facility, but they are sent directly 
    to the Repository and are not reprocessed in Scenarios 15 and 18.}
