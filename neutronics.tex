...
reactor physics of a 200 MWth pebble-bed \gls{HTGR}. While this reactor model 
...
The \gls{USNC} \gls{MMR} is a 5 MWe prismatic \gls{HTGR} that uses 
...
The 
small size of the core and higher enrichment cause an 
...
in the oscillations of the radial fluxes. The axial flux is taken along 
the z-axis, with the 
